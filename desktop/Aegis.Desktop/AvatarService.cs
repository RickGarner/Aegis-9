...
public sealed class AvatarService : IAvatarService
{
    ...
    private readonly AegisDesktopOptions _options;
    ...
    public AvatarService(UserPreferences preferences, AegisDesktopOptions options, AvatarAssetCatalog catalog, ISpeechService speechService)
    {
