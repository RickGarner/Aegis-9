...
public partial class SettingsWindow : Window
{
    ...
    private readonly AegisDesktopOptions _options = AegisDesktopOptions.Load();
    ...
    private void ApplyPreferences()
    {
        ...
        _preferences.SelectedAvatarId = AvatarChoiceInput.SelectedValue as string ?? "aegis9-male";
