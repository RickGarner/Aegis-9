...
public partial class AvatarWindow : Window
{
    ...
    private static string ResolveHostRuntimeRoot()
    {
        ...
        while (current is not null)
        {
            ...
            var source = Path.Combine(current.FullName, "desktop", "Aegis.Desktop", "Assets", "AvatarHost");
    ...
    private static string ResolveAvatarsRoot()
    {
        ...
        while (current is not null)
        {
            ...
            var source = Path.Combine(current.FullName, "desktop", "Aegis.Desktop", "Assets", "Avatars");
            if (Directory.Exists(source))
            {
                return source;
            }
